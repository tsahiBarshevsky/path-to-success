    ...
    return (
        <div className="footer-container" title="Photo by Janko Ferlič from Unsplash">
            ...
            <div className="footer-content">
                <h2>אודות</h2>
                <p className="about">
                    היי, שמי צחי ואני בוגר המכון הטכנולוגי בחולון.
                    סיימתי את לימודיי ב-2019 אחרי 4 שנים מאתגרות, ומאז מתעניין בפיתוח אתרים. במהלך התואר סיכמתי לא מעט מחומרי הלימוד, ואני יודע עד כמה התואר הזה לא פשוט, 
                    לכן החלטתי להקים את האתר הזה על מנת לרכז את החומרים שלי ולעזור במה שניתן ללומדים במכון כעת.
                </p>
